...
function copy(a) {
  navigator.clipboard.writeText("https://9url.tech/"+a);
  var k = document.getElementById("cb" + a)
  k.innerHTML = "Copied"
}
...
async function geturl(email) {
  ...
  try {
    ...
    console.log(e); document.getElementById("loader").innerHTML = `<p>No Url's found please verify your email`
  }
}
